 ...
 * @author Abby
 */
public class ADHistoryTab extends javax.swing.JFrame {

    /**
     * Creates new form ADHistoryTab
     */
    public ADHistoryTab() {
        initComponents();
    ...
    private void initComponents() {
        ...
        historyTable.setFont(new java.awt.Font("Calibri", 0, 13)); // NOI18N
        ...
        historyTable.setGridColor(new java.awt.Color(204, 204, 255));
        historyTable.setRequestFocusEnabled(false);
        historyTable.setRowHeight(18);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ADHistoryTab.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ADHistoryTab().setVisible(true);
            }
        });
    }
