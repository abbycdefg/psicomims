 ...
 * @author Abby
 */
public class ADDeleteOutletScreen extends javax.swing.JFrame {

    /**
     * Creates new form ADDeleteOutletScreen
     */
    public ADDeleteOutletScreen() {
        initComponents();
    ...
    private void initComponents() {
        ...
        deleteLabel.setText("DELETE OUTLET");
        ...
        confirmationLabel.setText("Are you sure you want to delete this outlet?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ADDeleteOutletScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ADDeleteOutletScreen().setVisible(true);
            }
        });
    }
    ...
    private HashMap doCommand(String command, String outletId) throws Exception
    {
