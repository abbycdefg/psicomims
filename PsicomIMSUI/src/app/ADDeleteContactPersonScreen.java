 ...
 * @author Abby
 */
public class ADDeleteContactPersonScreen extends javax.swing.JFrame {

    /**
     * Creates new form ADDeleteContactPersonScreen
     */
    public ADDeleteContactPersonScreen() {
        initComponents();
    ...
    private void initComponents() {
        ...
        confirmationLabel.setText("Are you sure you want to delete this contact person?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ADDeleteContactPersonScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ADDeleteContactPersonScreen().setVisible(true);
            }
        });
    }
